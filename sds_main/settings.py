...
CSRF_FAILURE_VIEW = "sds.csrf.csrf_failure"
...
TEMPLATES = [    
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'sds.context_processors.student_portal_features',
            ],
        },
    },
]
...
# Attendance flow template IDs
MSG91_ATTENDANCE_CHECKIN_TEMPLATE = "69e9ebdab7357117ee02be94"
...
# Attendance-only SMS flows are enabled by default and can be disabled via env.
ATTENDANCE_SMS_ENABLED = _env_bool("ATTENDANCE_SMS_ENABLED", True)
